...
const PRODUCTS = [
  {
    id: 'premium-cups',
    name: 'Premium Silicone Hijama Cups',
    slug: 'premium-cups',
    category: 'cups',
    ...
    description: 'Our Premium Silicone Hijama Cups are crafted from 100% medical-grade silicone, ensuring safe and effective cupping therapy. The flexible material allows for precise pressure control, making them ideal for both wet and dry cupping. Each set includes 12 cups in various sizes to cover different body areas.',
  ...
  },
  {
    ...
    name: 'Electric Smart Cupping Device',
    ...
    description: 'The Electric Smart Cupping Device combines traditional hijama therapy with modern technology. Features adjustable suction strength (1-9 levels), built-in heat therapy, and rechargeable battery. Perfect for clinics and home use with zero manual effort required.',
  ...
  },
  {
    ...
    name: 'Traditional Fire Cupping Glass Set',
    ...
    description: 'Crafted from premium borosilicate glass, these Traditional Fire Cupping Glasses are designed for the classic Sunnah hijama method. High heat resistance ensures safe fire cupping. Smooth rounded edges prevent skin irritation. Available in three sizes for full-body coverage.',
    features: ['High-grade borosilicate glass', 'Heat resistant up to 500°C', 'Smooth rounded rims', 'Available in 3 sizes', 'Professional clinic grade'],
    specs: { Material: 'Borosilicate glass', Sizes: 'Small / Medium / Large', Quantity: '6 cups per set', Heat: 'Up to 500°C', Thickness: '3mm wall' },
  ...
  },
  {
    ...
    badge: 'Top Rated',
    badgeType: 'teal',
    shortDesc: 'Complete magnetic vacuum cupping kit with pump gun and 16 cups in 4 sizes.',
    description: 'The Magnetic Vacuum Cupping Kit is a comprehensive set designed for professional hijama practitioners. Includes a precision vacuum pump gun with magnetic lock system, 16 high-quality cups in 4 sizes, and extension hose. The magnetic connector ensures airtight sealing every time.',
    features: ['16 cups (4 sizes)', 'Magnetic vacuum pump', 'Airtight seal technology', 'Extension hose included', 'Carry case included'],
    specs: { Cups: '16 pcs in 4 sizes', Pump: 'Magnetic lock system', Material: 'ABS + silicone', Includes: 'Pump, cups, case, hose', Usage: 'Professional & home' },
    images: ['assets/images/products/magnetic-vacuum-kit/main.jpg','assets/images/products/magnetic-vacuum-kit/image2.jpg']
  },
  {
    id: 'curve-cups',
    name: 'Contour Curve Cupping Set',
    slug: 'curve-cups',
    category: 'cups',
    categoryLabel: 'Cupping Sets',
    price: 749,
    ...
    description: 'Contour Curve Cups feature a unique ergonomic design that adapts to curved body surfaces like shoulders, knees, and joints. Made from flexible medical-grade silicone, these cups deliver optimal suction even on uneven surfaces, making them ideal for targeted therapy in hard-to-reach areas.',
    features: ['Ergonomic curved design', 'Flexible silicone', 'Fits curved body parts', 'Deep tissue therapy', 'Set of 8 cups'],
    specs: { Design: 'Ergonomic curve', Material: 'Medical silicone', Quantity: '8 cups', Sizes: '2 sizes', Ideal: 'Joints & shoulders' },
    images: ['assets/images/products/curve-cups/main.jpg','assets/images/products/curve-cups/image2.jpg']
  },
  {
    id: 'lancet-pen',
    name: 'Auto Lancet Pen (Hijama)',
    slug: 'lancet-pen',
    ...
    description: 'The Auto Lancet Pen provides precise, controlled incisions for wet hijama (Al-Hijamah Al-Ratibar). Features 5 adjustable depth settings to suit different skin types and patient needs. Each click delivers a consistent, safe incision depth, reducing patient discomfort and ensuring hygiene.',
  ...
  },
  {
    ...
    description: 'Medical-grade latex examination gloves designed for hijama practitioners. Powder-coated for easy donning, textured fingertips for better grip, and pre-tested for pinhole integrity. Sold in boxes of 100 — enough for a full month of regular sessions.',
  ...
  },
  {
    ...
    name: 'Bamboo Cupping Set (Traditional)',
    ...
    description: 'Crafted from sustainably sourced bamboo, these traditional cupping cups are ideal for herbal steam cupping. The natural material allows herbal infusions to permeate during therapy, enhancing the healing benefits. Each set includes 8 handcrafted bamboo cups with varying diameters.',
  ...
  },
  {
    ...
    stock: 45,
    badge: null,
    shortDesc: 'Mini silicone facial cupping set for lymphatic drainage, glowing skin and anti-aging.',
    description: 'The Facial Cupping Set is designed for gentle facial lymphatic drainage and skin rejuvenation. Made from ultra-soft, hypoallergenic silicone, these mini cups create gentle suction to boost circulation, reduce puffiness, and promote collagen production. Perfect complement to your skincare routine.',
    ...
    <a href="/index.html" class="nav-logo" aria-label="Detoxy Hijama Home">
      <div class="nav-logo-mark" aria-hidden="true">
        <svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round">
          ...
          <path d="M8 8c-2 1-3 3-3 4s1 3 3 4"/>
        </svg>
      </div>
      <div>
...
<footer class="footer" role="contentinfo">
  <div class="footer-grid">
    <div>
      <div class="footer-brand-logo">
        <div class="footer-brand-logo-mark" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v3M12 19v3M2 12h3M19 12h3"/></svg>
        </div>
        <span class="footer-brand-name">Detoxy Hijama</span>
      </div>
      <p class="footer-desc">India's trusted manufacturer of clinical-grade hijama equipment. Factory direct pricing. Pan-India delivery from Madurai, Tamil Nadu.</p>
  ...
  <div class="footer-bottom">
    <p>&copy; ${new Date().getFullYear()} Detoxy Hijama. All rights reserved. Madurai, Tamil Nadu.</p>
...
document.addEventListener('DOMContentLoaded', () => {
  // Mount header
  // FIX 1: Was rendering twice — first via hm.innerHTML, then again via replaceWith().
  // The innerHTML write was redundant dead work that created a brief broken DOM state.
  // A single createContextualFragment → replaceWith() is the correct pattern.
  const hm = document.getElementById('header-mount');
  if (hm) {
    const page = hm.dataset.page || '';
    hm.replaceWith(document.createRange().createContextualFragment(renderHeader(page)));
  }

  // Mount footer
  const fm = document.getElementById('footer-mount');
  if (fm) fm.outerHTML = renderFooter();
